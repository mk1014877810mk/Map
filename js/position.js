$(function () {
  var goal = window.sessionStorage.getItem("address");
  console.log(goal)
  map_way(goal);
  function map_way(goal) {
    ...
    geolocation.getCurrentPosition(function (position) {
      ...
      var opts = { offset: new BMap.Size(40, 100) }   // 设置比例尺的位置
      map.addControl(new BMap.ScaleControl(opts));   // 添加比例尺控件  
      var ops1 = { offset: new BMap.Size(40, 110) }    // 设置地图放大缩小按钮的位置
      ...
      $("#s-more").on("click", function () {
        ...
        if ($(this).children().hasClass("icon-yincang4")) {
          $(this).removeClass("active").children().removeClass("icon-yincang4").addClass("icon-daohang1");
        } else {
          $(this).addClass("active").children().removeClass("icon-daohang1").addClass("icon-yincang4");
      ...
      function setHeight() {
        ...
        timer = setInterval(function () {
          var top = $("#r-start").height() + $("#r-end").height() + $(".method").height() + $("#r-result>div>h1").height() + $("#r-result>div>.navtrans-view.expand").height() + $(".select").height() + 63;
      ...
      function s_foot() {
        ...
        setIn = setInterval(function () {
          if ($("#hidden .suggest-plan-des").html()) {
            temp = $("#hidden .suggest-plan-des").html().split("|");
            foot_html = temp[1] + " | " + temp[0];
            $("#way").html(foot_html);
          }
        }, 300);
      }
